...
<section class="auctions">
    <div class="container">
    <?php
        $sql = "SELECT * FROM products INNER JOIN categories ON products.product_category = categories.category_id INNER JOIN users ON products.user_id = users.user_id AND products.product_category = 2";
